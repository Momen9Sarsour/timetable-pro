...
<div class="container-fluid">
        ...
        <div class="col-12">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                <div>
                    ...
                    <p class="text-muted mb-0">Create and manage different types of academic subjects</p>
                </div>

                <div class="d-flex gap-2 flex-wrap">
                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addSubjectTypeModal">
                        <i class="fas fa-plus me-1"></i>
                        <span class="d-none d-sm-inline">Add New Type</span>
                    </button>
                    <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#bulkUploadSubjectTypesModal">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-transparent border-bottom-0 pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-primary bg-opacity-10 text-primary">{{ $subjectTypes->total() }} Total</span>
                    </div>
                </div>
                            ...
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    @foreach ($subjectTypes as $index => $type)
                                        @php
                                            $subjectCount = $type->subjects()->count();
                                        @endphp
                                        <tr class="border-bottom">
                                            <td class="text-center text-muted">
                                                <small>{{ $subjectTypes->firstItem() + $index }}</small>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div class="fw-medium">{{ $type->subject_type_name }}</div>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group btn-group-sm" role="group">
                                                    <button class="btn btn-outline-primary btn-sm"
                                                            ...
                                                            data-bs-target="#editSubjectTypeModal-{{ $type->id }}"
                                                            title="Edit Subject Type">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <button class="btn btn-outline-danger btn-sm"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#deleteSubjectTypeModal-{{ $type->id }}"
                                ...
                                <div class="card mb-3 border">
                                    <div class="card-body p-3">
                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-center gap-2 mb-2">
                                                    ...
                                                    <div>
                                                        <h6 class="card-title mb-1">{{ $type->subject_type_name }}</h6>
                                                        @if($subjectCount > 0)
                                                            <span class="badge bg-info bg-opacity-10 text-info">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editSubjectTypeModal-{{ $type->id }}">
                                                            <i class="fas fa-edit me-2"></i>Edit
                                                        </button>
                                                    </li>
                                                    @if($subjectCount == 0)
                                                        <li>
                                                            <button class="dropdown-item text-danger" data-bs-toggle="modal" data-bs-target="#deleteSubjectTypeModal-{{ $type->id }}">
                                        ...
                                        <div class="d-flex justify-content-between text-muted small">
                                            ...
                                            <span class="text-muted">#{{ $subjectTypes->firstItem() + $index }}</span>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                    ...
                    @else
                        ...
                        <div class="text-center py-5">
                            <div class="empty-state">
                                <i class="fas fa-tags text-muted opacity-50" style="font-size: 4rem;"></i>
                                <h5 class="mt-3 text-muted">No Subject Types Found</h5>
                                <p class="text-muted mb-4">Start by adding subject types to categorize your academic courses.</p>
                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addSubjectTypeModal">
                                    <i class="fas fa-plus me-2"></i>Add First Subject Type
                                </button>
                            </div>
                        </div>
                    @endif
    ...
    <!-- Include Modals for each subject type -->
    @foreach($subjectTypes as $subjectType)
        @include('dashboard.data-entry.partials._subject_type_modals', ['subjectType' => $subjectType])
    @endforeach

    <!-- Include Add Subject Type Modal -->
