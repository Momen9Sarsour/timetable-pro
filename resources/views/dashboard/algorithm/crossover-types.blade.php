            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                <div>
                    <h4 class="page-title mb-1">
                        ...
                        Manage Crossover Methods
                    </h4>
                    <p class="text-muted mb-0">Configure genetic algorithm crossover techniques</p>
                </div>

                <div class="d-flex gap-2 flex-wrap">
                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addCrossoverModal">
                ...
                <div class="card-header bg-transparent border-bottom-0 pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <h6 class="card-title mb-0">
                            ...
                            Crossover Methods List
                        </h6>
                        <span class="badge bg-primary bg-opacity-10 text-primary">{{ $crossoverTypes->total() }} Total</span>
                    </div>
                </div>

                <div class="card-body pt-3">
                    @if($crossoverTypes->count() > 0)
                        <!-- Desktop Table -->
                        <div class="table-responsive d-none d-lg-block">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    @foreach ($crossoverTypes as $index => $type)
                                        <tr class="border-bottom">
                                            <td class="text-center text-muted">
                                                <small>{{ $crossoverTypes->firstItem() + $index }}</small>
                                            </td>
                                            <td class="fw-medium">
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group btn-group-sm" role="group">
                                                    <button class="btn btn-outline-primary btn-sm"
                                                            ...
                                                            data-bs-target="#editCrossoverModal-{{ $type->crossover_id }}"
                                                            title="Edit Method">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <button class="btn btn-outline-danger btn-sm"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#deleteCrossoverModal-{{ $type->crossover_id }}"
                                                            title="Delete Method">
                                ...
                                <div class="card mb-3 border">
                                    <div class="card-body p-3">
                                        ...
                                        <div class="d-flex justify-content-between text-muted small">
                                            <span>Method #{{ $crossoverTypes->firstItem() + $index }}</span>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                                        ...
                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#editCrossoverModal-{{ $type->crossover_id }}">
                                                            <i class="fas fa-edit me-2"></i>Edit
                                                        </button>
                                                    </li>
                                                    <li>
                                                        <button class="dropdown-item text-danger" data-bs-toggle="modal" data-bs-target="#deleteCrossoverModal-{{ $type->crossover_id }}">
                    ...
                    @else
                        ...
                        <div class="text-center py-5">
                            <div class="empty-state">
                                <i class="fas fa-code-branch text-muted opacity-50" style="font-size: 4rem;"></i>
                                <h5 class="mt-3 text-muted">No Crossover Methods Found</h5>
                                <p class="text-muted mb-4">Start by adding crossover methods to configure your genetic algorithm.</p>
