        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Manage and execute genetic algorithm populations for schedule optimization</p>
                </div>
                <div>
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    @if($population->status !== 'running')
                                        <button class="btn btn-sm btn-success"
                                                onclick="runGA({{ $population->population_id }})"
                                                title="Run GA">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label fw-bold">Theory Slots <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label fw-bold">Practical Slots <span class="text-danger">*</span></label>
                            ...
                            <div class="card border-0 shadow-sm">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">Crossover Type <span class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">Selection Type <span class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label fw-bold">Mutation Type <span class="text-danger">*</span></label>
                            ...
                            <div class="card border-0 shadow-sm mb-3">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">Number of chromosomes (schedules) in population</small>
                                    </div>
                            ...
                            <div class="card border-0 shadow-sm">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="crossover_rate"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="mutation_rate"
                                               value="0.05" min="0" max="1" required>
...
$(document).ready(function() {
    ...
    $('#createPopulationForm').on('submit', function(e) {
        e.preventDefault();
        if (confirm('Are you sure you want to generate this population? This may take several minutes.')) {
            this.submit();
        }
    });
});
...
function validateParameters() {
    ...
    .done(function(response) {
        if (response.success) {
            ...
            $('#validationMessage').html('<i class="fas fa-check-circle me-2"></i>All parameters are valid!');
...
function confirmRunGA() {
    ...
    form.append($('<input>', { type: 'hidden', name: 'run_in_background', value: runInBackground ? '1' : '0' }));
